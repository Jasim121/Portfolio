...
// gsap
  ...
  .from(".himg", 2.5,{y:50,opacity:0,duration:0.4,})
...
// skill area
  ...
  timeline1.from(".skill_area h1",{x:-150,
      opacity:0,duration:1.5});
...
timeline3.from(".services h1",{x:150,
    opacity:0,duration:1.5});

    timeline3.from(".cardarea",{x:150, stagger:0.5,
      opacity:0,});
// portfolio area
...
timeline4.from(".portfolio h1",{x:-150,
    opacity:0,duration:1.5});
...
timeline5.from(".testomonial h1",{x:150,
    opacity:0,duration:1.5});
...
timeline10.from(".sub_contact h1",{x:150,
    opacity:0,duration:1.5});
...
timeline6.from(".contact h1",{x:-150,
  opacity:0,duration:1.5});
// Form area
    ...
    timeline7.from(".input-box",{translateX:200,
      stagger:0.2,
      delay:0.2,
      opacity:0,
      duration:2,
